# =======================================================================================
# DIGIvloot: add tripdata v2.0.r
# 
# Function to read data, check it and add to RData sets
#
# Martin Pastoors
#
# 17/01/2025 adapted from FLYSHOOT add tripdata v2.0 
# 
# TO DO: 
# 
# =========================================================================================
...
onedrive   = "C:/Users/MartinPastoors/Martin Pastoors/DIGIvloot - data - data/rdata"
tripdir    = "C:/Users/MartinPastoors/Martin Pastoors/DIGIvloot - data - data/tripdata"
...
source("r/DIGIVLOOT utils.R")
source("r/DIGIVLOOT add tripdata v2.0 functions.r")
...
# haul <- kisten <- elog <- elog_trek <- trip <- data.frame(stringsAsFactors = FALSE)
